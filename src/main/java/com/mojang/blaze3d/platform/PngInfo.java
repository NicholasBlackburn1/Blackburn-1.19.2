...
public class PngInfo
{
    ...
    public PngInfo(Supplier<String> pFileName, InputStream pTextureStream) throws IOException
    {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    throw new IOException("Could not read info from the PNG file " + (String)pFileName.get() + " " + STBImage.stbi_failure_reason());
                                }
