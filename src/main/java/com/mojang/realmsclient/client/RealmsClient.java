...
public class RealmsClient
{
    ...
    {
        String s = this.url("worlds" + "/$WORLD_ID/slot/$SLOT_ID".replace("$WORLD_ID", String.valueOf(pWorldId)).replace("$SLOT_ID", String.valueOf(p_87181_)));
    ...
    {
        String s = this.url("worlds" + "/$WORLD_ID/slot/$SLOT_ID".replace("$WORLD_ID", String.valueOf(pWorldId)).replace("$SLOT_ID", String.valueOf(p_87178_)));
    ...
    {
        String s = this.url("worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(pWorldId)), "backupId=" + p_87226_);
    ...
    {
        String s = "/minigames/$MINIGAME_ID/$WORLD_ID".replace("$MINIGAME_ID", p_87234_).replace("$WORLD_ID", String.valueOf(pWorldId));
    ...
    {
        String s = this.url("worlds" + "/$WORLD_ID/slot/$SLOT_ID/download".replace("$WORLD_ID", String.valueOf(pWorldId)).replace("$SLOT_ID", String.valueOf(p_87211_)));
        String s1 = this.execute(Request.get(s));
    ...
    private static String getHttpCodeDescription(int p_200937_)
    {
        ...
        {
            case 429:
                s = I18n.a("mco.errorMessage.serviceBusy");
                break;
