...
public class RealmsMainScreen extends RealmsScreen
{
    ...
    void updateButtonStates(@Nullable RealmsServer pRealmsServer)
    {
        ...
        {
            a(new AbstractWidget[] {this.playButton, this.renewButton, this.configureButton, this.createTrialButton, this.buyARealmButton, this.closeButton, this.newsButton, this.pendingInvitesButton, this.showPopupButton, this.leaveButton});
        }
    }
    ...
    private DataFetcher.Subscription initDataFetcher(RealmsDataFetcher p_238836_)
    {
        ...
        datafetcher$subscription.subscribe(p_238836_.pendingInvitesTask, (p_240510_) ->
        {
            ...
            {
                this.minecraft.getNarrator().sayNow(Component.a("mco.configure.world.invite.narration", this.numberOfPendingInvites));
            }
        });
    ...
    void drawExpiring(PoseStack p_86538_, int p_86539_, int p_86540_, int p_86541_, int p_86542_, int p_86543_)
    {
        ...
        if (p_86541_ >= p_86539_ && p_86541_ <= p_86539_ + 9 && p_86542_ >= p_86540_ && p_86542_ <= p_86540_ + 27 && p_86542_ < this.height - 40 && p_86542_ > 32 && !this.shouldShowPopup())
        {
            ...
            {
                this.a(Component.a("mco.selectServer.expires.days", p_86543_));
            }
        }
    }
    ...
    class ServerEntry extends RealmsMainScreen.Entry
    {
        ...
        private void renderLegacy(RealmsServer p_86886_, PoseStack p_86887_, int p_86888_, int p_86889_, int p_86890_, int p_86891_)
        {
            ...
            else
            {
                ...
                if (!"0".equals(p_86886_.serverPing.nrOfPlayers))
                {
                    ...
                    {
                        RealmsMainScreen.this.a(Component.literal(p_86886_.serverPing.playerList));
                    }
                }
        ...
        {
            return (Component)(this.serverData.state == RealmsServer.State.UNINITIALIZED ? RealmsMainScreen.UNITIALIZED_WORLD_NARRATION : Component.a("narrator.select", this.serverData.name));
        }
