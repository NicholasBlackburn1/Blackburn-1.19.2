...
public class RealmsConfigureWorldScreen extends RealmsScreen
{
    ...
    private void switchToMinigame()
    {
        ...
        realmsselectworldtemplatescreen.a(Component.translatable("mco.minigame.world.info.line1"), Component.translatable("mco.minigame.world.info.line2"));
    ...
    private void drawExpiring(PoseStack p_88474_, int p_88475_, int p_88476_, int p_88477_, int p_88478_, int p_88479_)
    {
        ...
        if (p_88477_ >= p_88475_ && p_88477_ <= p_88475_ + 9 && p_88478_ >= p_88476_ && p_88478_ <= p_88476_ + 27)
        {
            ...
            {
                this.toolTip = Component.a("mco.selectServer.expires.days", p_88479_);
            }
        }
    }
