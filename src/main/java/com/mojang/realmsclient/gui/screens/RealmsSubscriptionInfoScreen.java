...
public class RealmsSubscriptionInfoScreen extends RealmsScreen
{
    ...
    private static final Component Q = Component.translatable("mco.configure.world.subscription.unknown");
    private final Screen lastScreen;
    final RealmsServer serverData;
    final Screen mainScreen;
    private Component daysLeft = Q;
    private Component startDate = Q;
    @Nullable
    ...
    {
        return CommonComponents.a(SUBSCRIPTION_TITLE, SUBSCRIPTION_START_LABEL, this.startDate, TIME_LEFT_LABEL, this.daysLeft);
    }
