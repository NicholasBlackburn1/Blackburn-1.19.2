...
public class VersionCheckThread extends Thread
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            URL url = new URL("http://optifine.net/version/1.19.2/HD_U.txt");
            httpurlconnection = (HttpURLConnection)url.openConnection();
            boolean flag = true;

            if (flag)
            {
                httpurlconnection.setRequestProperty("OF-MC-Version", "1.19.2");
                ...
                httpurlconnection.setRequestProperty("OF-Release", "H9");
            ...
            try
            {
                ...
                if (astring.length >= 1)
                {
                    ...
                    if (Config.compareRelease(s1, "H9") <= 0)
                    {
                        return;
                    }
