...
public class ModelAdapterBoat extends ModelAdapter
{
    ...
    {
        return new BoatModel(bakeModelLayer(ModelLayers.createBoatModelName(Boat.Type.OAK)), false);
    }
    ...
    {
        return this.makeEntityRender(modelBase, shadowSize, false);
    }

    protected IEntityRenderer makeEntityRender(Model modelBase, float shadowSize, boolean chest)
    {
        EntityRenderDispatcher entityrenderdispatcher = Minecraft.getInstance().getEntityRenderDispatcher();
        BoatRenderer boatrenderer = new BoatRenderer(entityrenderdispatcher.getContext(), chest);
