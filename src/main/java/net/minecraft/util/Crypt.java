...
public class Crypt
{
    ...
    {
        return rsaStringToKey(p_216070_, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", Crypt::b);
    }

    public static PublicKey stringToRsaPublicKey(String p_216081_) throws CryptException
    {
        return rsaStringToKey(p_216081_, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", Crypt::a);
    }
    ...
    private static PrivateKey b(byte[] p_216083_) throws CryptException
    {
        try
        {
    ...
    public static record SaltSignaturePair(long salt, byte[] signature)
    {
        ...
        public static void write(FriendlyByteBuf p_216101_, Crypt.SaltSignaturePair p_216102_)
        {
            ...
            p_216101_.a(p_216102_.signature);
        }
