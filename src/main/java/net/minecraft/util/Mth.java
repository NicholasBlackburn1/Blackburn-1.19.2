...
public class Mth
{
    ...
    public static double nextDouble(RandomSource pRandom, double pMinimum, double p_216266_)
    {
        return pMinimum >= p_216266_ ? pMinimum : pRandom.nextDouble() * (p_216266_ - pMinimum) + pMinimum;
    }
    ...
    public static UUID createInsecureUUID(RandomSource pRand)
    {
    ...
    public static int a(RandomSource p_216276_, double[] p_216277_)
    {
