...
default boolean a(byte[] p_216376_, byte[] p_216377_)
    {
    ...
    private static boolean a(SignatureUpdater p_216355_, byte[] p_216356_, Signature p_216357_) throws SignatureException
    {
    ...
    static SignatureValidator from(PublicKey p_216370_, String p_216371_)
    {
        return (p_216367_, p_216368_) ->
        {
            try {
                ...
                return a(p_216367_, p_216368_, signature);
            }
    ...
    static SignatureValidator from(ServicesKeyInfo p_216359_)
    {
        return (p_216362_, p_216363_) ->
        {
            ...
            try {
                return a(p_216362_, p_216363_, signature);
            }
