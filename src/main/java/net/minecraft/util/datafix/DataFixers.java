...
public class DataFixers
{
    ...
    private static void addFixers(DataFixerBuilder pBuilder)
    {
        ...
        pBuilder.addFixer(new OminousBannerRenameFix(schema91));
        ...
        pBuilder.addFixer(ItemRenameFix.create(schema98, "Rename bee_hive item to beehive", unaryoperator));
        pBuilder.addFixer(new PoiTypeRenameFix(schema98, "Rename bee_hive poi to beehive", unaryoperator));
        pBuilder.addFixer(BlockRenameFix.create(schema98, "Rename bee_hive block to beehive", unaryoperator));
        ...
        pBuilder.addFixer(new CriteriaRenameFix(schema162, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (p_216517_) ->
        {
            return immutablemap3.getOrDefault(p_216517_, p_216517_);
        }));
        Schema schema163 = pBuilder.addSchema(3087, SAME_NAMESPACED);
        pBuilder.addFixer(new EntityVariantFix(schema163, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), (p_216519_) ->
        {
            p_216519_.put(0, "minecraft:temperate");
            p_216519_.put(1, "minecraft:warm");
            p_216519_.put(2, "minecraft:cold");
        })::get));
        Schema schema164 = pBuilder.addSchema(3088, SAME_NAMESPACED);
        pBuilder.addFixer(new BlendingDataFix(schema164));
        Schema schema165 = pBuilder.addSchema(3090, SAME_NAMESPACED);
        pBuilder.addFixer(new EntityPaintingFieldsRenameFix(schema165));
        Schema schema166 = pBuilder.addSchema(3093, SAME_NAMESPACED);
        pBuilder.addFixer(new EntityGoatMissingStateFix(schema166));
        Schema schema167 = pBuilder.addSchema(3094, SAME_NAMESPACED);
        pBuilder.addFixer(new GoatHornIdFix(schema167));
        Schema schema168 = pBuilder.addSchema(3097, SAME_NAMESPACED);
        pBuilder.addFixer(new FilteredBooksFix(schema168));
        pBuilder.addFixer(new FilteredSignsFix(schema168));
        Map<String, String> map = Map.of("minecraft:british", "minecraft:british_shorthair");
        pBuilder.addFixer(new VariantRenameFix(schema168, "Rename british shorthair", References.ENTITY, "minecraft:cat", map));
        pBuilder.addFixer(new CriteriaRenameFix(schema168, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", (p_216531_) ->
        {
            return map.getOrDefault(p_216531_, p_216531_);
        }));
        pBuilder.addFixer(new PoiTypeRemoveFix(schema168, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
        Schema schema169 = pBuilder.addSchema(3108, SAME_NAMESPACED);
        pBuilder.addFixer(new BlendingDataRemoveFromNetherEndFix(schema169));
    }
