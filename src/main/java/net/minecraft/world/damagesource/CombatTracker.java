            ...
            if (combatentry != null && combatentry1.getSource() == DamageSource.FALL)
            {
                ...
                if (combatentry.getSource() != DamageSource.FALL && combatentry.getSource() != DamageSource.OUT_OF_WORLD)
                {
                    if (component2 != null && !component2.equals(component1))
                    {
                        ...
                        {
                            component = Component.a("death.fell.assist.item", this.mob.getDisplayName(), component2, itemstack1.getDisplayName());
                        }
                        else
                        {
                            component = Component.a("death.fell.assist", this.mob.getDisplayName(), component2);
                        }
                    }
                    else if (component1 != null)
                    {
                        ...
                        {
                            component = Component.a("death.fell.finish.item", this.mob.getDisplayName(), component1, itemstack.getDisplayName());
                        }
                        else
                        {
                            component = Component.a("death.fell.finish", this.mob.getDisplayName(), component1);
                        }
                    }
                    else
                    {
                        component = Component.a("death.fell.killer", this.mob.getDisplayName());
                    }
                }
                else
                {
                    component = Component.a("death.fell.accident." + this.getFallLocation(combatentry), this.mob.getDisplayName());
                }
            }
            else
            {
