...
public class VillagerGoalPackages
{
    ...
    {
        return ImmutableList.of(Pair.of(2, new SetWalkTargetFromBlockMemory(MemoryModuleType.HOME, pWalkingSpeed, 1, 150, 1200)), Pair.of(3, new ValidateNearbyPoi((p_217495_) ->
        {
            return p_217495_.is(PoiTypes.HOME);
        }, MemoryModuleType.HOME)), Pair.of(3, new SleepInBed()), Pair.of(5, new RunOne<>(ImmutableMap.of(MemoryModuleType.HOME, MemoryStatus.VALUE_ABSENT), ImmutableList.of(Pair.of(new SetClosestHomeAsWalkTarget(pWalkingSpeed), 1), Pair.of(new InsideBrownianWalk(pWalkingSpeed), 4), Pair.of(new GoToClosestVillage(pWalkingSpeed, 4), 2), Pair.of(new DoNothing(20, 40), 2)))), getMinimalLookBehavior(), Pair.of(99, new UpdateActivityFromSchedule()));
    }
