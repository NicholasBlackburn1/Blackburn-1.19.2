...
public class RandomPos
{
    ...
    @Nullable
    public static BlockPos generateRandomDirectionWithinRadians(RandomSource pRandom, int pMaxHorizontalDifference, int pYRange, int pY, double pX, double p_217861_, double pZ)
    {
        double d0 = Mth.atan2(p_217861_, pX) - (double)((float)Math.PI / 2F);
