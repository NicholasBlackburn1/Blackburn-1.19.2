...
public class GossipContainer
{
    ...
    private Collection<GossipContainer.GossipEntry> selectGossipsForTransfer(RandomSource pRand, int pGossipAmount)
    {
    ...
    public void transferFrom(GossipContainer pGossip, RandomSource pRand, int pGossipAmount)
    {
