...
public class PiglinSpecificSensor extends Sensor<LivingEntity>
{
    ...
    protected void doTick(ServerLevel pLevel, LivingEntity pEntity)
    {
        ...
        for (LivingEntity livingentity : nearestvisiblelivingentities.findAll((p_186156_0_) ->
    {
        return true;
    }))
        {
    ...
    {
        return BlockPos.findClosestMatch(pLivingEntity.blockPosition(), 8, 4, (p_186158_1_) ->
        {
            return isValidRepellent(pLevel, p_186158_1_);
        });
    }
