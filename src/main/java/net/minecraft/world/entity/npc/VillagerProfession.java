...
public record VillagerProfession(String name, Predicate<Holder<PoiType>> heldJobSite, Predicate<Holder<PoiType>> acquirableJobSite, ImmutableSet<Item> requestedItems, ImmutableSet<Block> secondaryPoi, @Nullable SoundEvent workSound)
{
    ...
    private static VillagerProfession register(String pName, ResourceKey<PoiType> pPointOfInterest, @Nullable SoundEvent pSound)
    {
        return register(pName, (p_219668_) ->
        {
            return p_219668_.is(pPointOfInterest);
        }, (p_219640_) ->
        {
            return p_219640_.is(pPointOfInterest);
        }, pSound);
    }
    ...
    private static VillagerProfession register(String pName, ResourceKey<PoiType> pPointOfInterest, ImmutableSet<Item> pSpecificItems, ImmutableSet<Block> pRelatedLevelBlocks, @Nullable SoundEvent pSound)
    {
        return register(pName, (p_238234_) ->
        {
            return p_238234_.is(pPointOfInterest);
        }, (p_238237_) ->
        {
            return p_238237_.is(pPointOfInterest);
        }, pSpecificItems, pRelatedLevelBlocks, pSound);
    }
