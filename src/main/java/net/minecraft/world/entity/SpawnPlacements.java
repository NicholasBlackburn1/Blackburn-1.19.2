...
public class SpawnPlacements
{
    ...
    public static <T extends Entity> boolean checkSpawnRules(EntityType<T> pEntityType, ServerLevelAccessor pLevel, MobSpawnType pReason, BlockPos pPos, RandomSource pRand)
    {
        SpawnPlacements.Data spawnplacements$data = DATA_BY_TYPE.get(pEntityType);
