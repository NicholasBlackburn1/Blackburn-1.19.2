...
public abstract class Projectile extends Entity
{
    ...
    {
        Vec3 vec3 = (new Vec3(pX, p_37267_, pY)).normalize().add(this.random.triangle(0.0D, 0.0172275D * (double)pZ), this.random.triangle(0.0D, 0.0172275D * (double)pZ), this.random.triangle(0.0D, 0.0172275D * (double)pZ)).scale((double)p_37269_);
