...
public final class DensityFunctions
{
    ...
    protected static record Noise(DensityFunction.NoiseHolder noise, double xzScale, double yScale) implements DensityFunction
    {
        ...
        public void a(double[] p_224079_, DensityFunction.ContextProvider p_224080_)
        {
            p_224080_.a(p_224079_, this);
        }
    ...
    default void a(double[] p_224103_, DensityFunction.ContextProvider p_224104_)
        {
            p_224104_.a(p_224103_, this);
        }
    }
