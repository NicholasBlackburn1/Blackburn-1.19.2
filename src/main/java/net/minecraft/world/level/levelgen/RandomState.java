...
public final class RandomState
{
    ...
    {
        return create((NoiseGeneratorSettings)p_224575_.registryOrThrow(Registry.NOISE_GENERATOR_SETTINGS_REGISTRY).getOrThrow(p_224576_), p_224575_.registryOrThrow(Registry.NOISE_REGISTRY), p_224577_);
    }
