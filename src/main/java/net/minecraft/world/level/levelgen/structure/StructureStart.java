...
public final class StructureStart
{
    ...
    public void placeInChunk(WorldGenLevel pLevel, StructureManager pStructureManager, ChunkGenerator pChunkGenerator, RandomSource pRandom, BoundingBox pBox, ChunkPos pChunkPos)
    {
        ...
        if (!list.isEmpty())
        {
            ...
            this.structure.afterPlace(pLevel, pStructureManager, pChunkGenerator, pRandom, pBox, pChunkPos, this.pieceContainer);
        }
    }
