...
public class SurfaceSystem
{
    ...
    private static BlockState[] generateBands(RandomSource p_224642_)
    {
        ...
        a(p_224642_, ablockstate, 1, YELLOW_TERRACOTTA);
        a(p_224642_, ablockstate, 2, BROWN_TERRACOTTA);
        a(p_224642_, ablockstate, 1, RED_TERRACOTTA);
    ...
    private static void a(RandomSource p_224644_, BlockState[] p_224645_, int p_224646_, BlockState p_224647_)
    {
