...
public final class LevelStem
{
    ...
    public static Registry<LevelStem> sortMap(Registry<LevelStem> pMappedRegistry)
    {
        ...
        keysInOrder(pMappedRegistry.registryKeySet().stream()).forEach((p_223604_) ->
        {
            LevelStem levelstem = pMappedRegistry.get(p_223604_);

            if (levelstem != null)
            {
                writableregistry.register(p_223604_, levelstem, pMappedRegistry.lifecycle(levelstem));
            }
        });
