...
public class WardenSpawnTrackerCommand
{
    ...
    private static int setWarningLevel(CommandSourceStack p_214783_, Collection <? extends Player > p_214784_, int p_214785_)
    {
        ...
        {
            player.getWardenSpawnTracker().setWarningLevel(p_214785_);
        }

        if (p_214784_.size() == 1)
        {
            p_214783_.sendSuccess(Component.a("commands.warden_spawn_tracker.set.success.single", p_214784_.iterator().next().getDisplayName()), true);
        }
        else
        {
            p_214783_.sendSuccess(Component.a("commands.warden_spawn_tracker.set.success.multiple", p_214784_.size()), true);
        }
    ...
    private static int resetTracker(CommandSourceStack p_214780_, Collection <? extends Player > p_214781_)
    {
        ...
        if (p_214781_.size() == 1)
        {
            p_214780_.sendSuccess(Component.a("commands.warden_spawn_tracker.clear.success.single", p_214781_.iterator().next().getDisplayName()), true);
        }
        else
        {
            p_214780_.sendSuccess(Component.a("commands.warden_spawn_tracker.clear.success.multiple", p_214781_.size()), true);
        }
