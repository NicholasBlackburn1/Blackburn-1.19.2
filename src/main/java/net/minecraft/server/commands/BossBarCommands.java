...
public class BossBarCommands
{
    ...
    {
        return Component.a("commands.bossbar.create.failed", p_136636_);
    });
    private static final DynamicCommandExceptionType ERROR_DOESNT_EXIST = new DynamicCommandExceptionType((p_136623_) ->
    {
        return Component.a("commands.bossbar.unknown", p_136623_);
    });
    ...
    {
        pSource.sendSuccess(Component.a("commands.bossbar.get.value", pBossbar.getDisplayName(), pBossbar.getValue()), true);
        return pBossbar.getValue();
    }

    private static int getMax(CommandSourceStack pSource, CustomBossEvent pBossbar)
    {
        pSource.sendSuccess(Component.a("commands.bossbar.get.max", pBossbar.getDisplayName(), pBossbar.getMax()), true);
    ...
    private static int getVisible(CommandSourceStack pSource, CustomBossEvent pBossbar)
    {
        ...
        {
            pSource.sendSuccess(Component.a("commands.bossbar.get.visible.visible", pBossbar.getDisplayName()), true);
            return 1;
        }
        else
        {
            pSource.sendSuccess(Component.a("commands.bossbar.get.visible.hidden", pBossbar.getDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int getPlayers(CommandSourceStack pSource, CustomBossEvent pBossbar)
    {
        ...
        {
            pSource.sendSuccess(Component.a("commands.bossbar.get.players.none", pBossbar.getDisplayName()), true);
        }
        else
        {
            pSource.sendSuccess(Component.a("commands.bossbar.get.players.some", pBossbar.getDisplayName(), pBossbar.getPlayers().size(), ComponentUtils.formatList(pBossbar.getPlayers(), Player::getDisplayName)), true);
        }
    ...
    private static int setVisible(CommandSourceStack pSource, CustomBossEvent pBossbar, boolean pVisible) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            if (pVisible)
            {
                pSource.sendSuccess(Component.a("commands.bossbar.set.visible.success.visible", pBossbar.getDisplayName()), true);
            }
            else
            {
                pSource.sendSuccess(Component.a("commands.bossbar.set.visible.success.hidden", pBossbar.getDisplayName()), true);
            }
    ...
    private static int setValue(CommandSourceStack pSource, CustomBossEvent pBossbar, int pValue) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(Component.a("commands.bossbar.set.value.success", pBossbar.getDisplayName(), pValue), true);
            return pValue;
        }
    }
    ...
    private static int setMax(CommandSourceStack pSource, CustomBossEvent pBossbar, int pMax) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(Component.a("commands.bossbar.set.max.success", pBossbar.getDisplayName(), pMax), true);
            return pMax;
        }
    }
    ...
    private static int setColor(CommandSourceStack pSource, CustomBossEvent pBossbar, BossEvent.BossBarColor pColor) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(Component.a("commands.bossbar.set.color.success", pBossbar.getDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int setStyle(CommandSourceStack pSource, CustomBossEvent pBossbar, BossEvent.BossBarOverlay pStyle) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(Component.a("commands.bossbar.set.style.success", pBossbar.getDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int setName(CommandSourceStack pSource, CustomBossEvent pBossbar, Component pName) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(Component.a("commands.bossbar.set.name.success", pBossbar.getDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int setPlayers(CommandSourceStack pSource, CustomBossEvent pBossbar, Collection<ServerPlayer> pPlayers) throws CommandSyntaxException
    {
        ...
        else
        {
            if (pBossbar.getPlayers().isEmpty())
            {
                pSource.sendSuccess(Component.a("commands.bossbar.set.players.success.none", pBossbar.getDisplayName()), true);
            }
            else
            {
                pSource.sendSuccess(Component.a("commands.bossbar.set.players.success.some", pBossbar.getDisplayName(), pPlayers.size(), ComponentUtils.formatList(pPlayers, Player::getDisplayName)), true);
            }
    ...
    private static int listBars(CommandSourceStack pSource)
    {
        ...
        {
            pSource.sendSuccess(Component.a("commands.bossbar.list.bars.some", collection.size(), ComponentUtils.formatList(collection, CustomBossEvent::getDisplayName)), false);
        }
    ...
    private static int createBar(CommandSourceStack pSource, ResourceLocation pId, Component pDisplayName) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(Component.a("commands.bossbar.create.success", custombossevent.getDisplayName()), true);
    ...
    private static int removeBar(CommandSourceStack pSource, CustomBossEvent pBossbar)
    {
        ...
        pSource.sendSuccess(Component.a("commands.bossbar.remove.success", pBossbar.getDisplayName()), true);
        return custombossevents.getEvents().size();
    }
