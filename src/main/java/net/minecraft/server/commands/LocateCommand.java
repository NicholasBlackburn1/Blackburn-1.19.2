...
public class LocateCommand
{
    ...
    public static void register(CommandDispatcher<CommandSourceStack> pDispatcher)
    {
        ...
        {
            return locatePoi((CommandSourceStack)p_214465_.getSource(), ResourceOrTagLocationArgument.getRegistryType(p_214465_, "poi", Registry.POINT_OF_INTEREST_TYPE_REGISTRY, ERROR_POI_INVALID));
        }))));
    }
    ...
    public static int showLocateResult(CommandSourceStack p_214475_, ResourceOrTagLocationArgument.Result<?> p_214476_, BlockPos p_214477_, Pair < BlockPos, ? extends Holder<? >> p_214478_, String p_214479_, boolean p_214480_)
    {
        ...
        Component component = ComponentUtils.wrapInSquareBrackets(Component.a("chat.coordinates", blockpos.getX(), s1, blockpos.getZ())).withStyle((p_214489_) ->
        {
        ...
        p_214475_.sendSuccess(Component.a(p_214479_, s, component, i), false);
        return i;
    }
