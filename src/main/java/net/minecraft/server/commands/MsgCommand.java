...
public class MsgCommand
{
    ...
    private static int sendMessage(CommandSourceStack pSource, Collection<ServerPlayer> pRecipients, MessageArgument.ChatMessage pMessage)
    {
        ChatType.Bound chattype$bound = ChatType.bind(ChatType.MSG_COMMAND_INCOMING, pSource);
        pMessage.resolve(pSource, (p_243178_) ->
        {
