...
public class ListPlayersCommand
{
    ...
    private static int listPlayersWithUuids(CommandSourceStack pSource)
    {
        ...
        {
            return Component.a("commands.list.nameAndId", p_137819_.getName(), p_137819_.getGameProfile().getId());
        });
    }
    ...
    private static int format(CommandSourceStack pSource, Function<ServerPlayer, Component> pNameExtractor)
    {
        ...
        pSource.sendSuccess(Component.a("commands.list.players", list.size(), playerlist.getMaxPlayers(), component), false);
        return list.size();
    }
}
