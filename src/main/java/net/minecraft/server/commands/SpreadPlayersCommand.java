...
public class SpreadPlayersCommand
{
    ...
    {
        return Component.a("commands.spreadplayers.failed.teams", p_138745_, p_138746_, p_138747_, p_138748_);
    });
    ...
    {
        return Component.a("commands.spreadplayers.failed.entities", p_138723_, p_138724_, p_138725_, p_138726_);
    });
    ...
    {
        return Component.a("commands.spreadplayers.failed.invalid.height", p_201854_, p_201855_);
    });
    ...
    private static int spreadPlayers(CommandSourceStack p_138703_, Vec2 p_138704_, float p_138705_, float p_138706_, int p_138707_, boolean p_138708_, Collection <? extends Entity > p_138709_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            a(p_138704_, (double)p_138705_, serverlevel, randomsource, d0, d1, d2, d3, p_138707_, aspreadplayerscommand$position, p_138708_);
            double d4 = a(p_138709_, serverlevel, aspreadplayerscommand$position, p_138707_, p_138708_);
            p_138703_.sendSuccess(Component.a("commands.spreadplayers.success." + (p_138708_ ? "teams" : "entities"), aspreadplayerscommand$position.length, p_138704_.x, p_138704_.y, String.format(Locale.ROOT, "%.2f", d4)), true);
    ...
    private static void a(Vec2 p_214741_, double p_214742_, ServerLevel p_214743_, RandomSource p_214744_, double p_214745_, double p_214746_, double p_214747_, double p_214748_, int p_214749_, SpreadPlayersCommand.Position[] p_214750_, boolean p_214751_) throws CommandSyntaxException
    {
        boolean flag = true;
    ...
    private static SpreadPlayersCommand.Position[] createInitialPositions(RandomSource pRandom, int pCount, double pMinX, double p_214737_, double pMinZ, double p_214739_)
    {
        ...
        for (int i = 0; i < aspreadplayerscommand$position.length; ++i)
        {
            ...
            spreadplayerscommand$position.randomize(pRandom, pMinX, p_214737_, pMinZ, p_214739_);
    ...
    static class Position
    {
        ...
        public void randomize(RandomSource pRandom, double pMinX, double p_214755_, double pMinZ, double p_214757_)
        {
            this.x = Mth.nextDouble(pRandom, pMinX, pMinZ);
            this.z = Mth.nextDouble(pRandom, p_214755_, p_214757_);
        }
    }
}
