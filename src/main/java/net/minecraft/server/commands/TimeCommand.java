...
public class TimeCommand
{
    ...
    {
        pSource.sendSuccess(Component.a("commands.time.query", pTime), false);
        return pTime;
    }
    ...
    public static int setTime(CommandSourceStack pSource, int pTime)
    {
        ...
        pSource.sendSuccess(Component.a("commands.time.set", pTime), true);
    ...
    public static int addTime(CommandSourceStack pSource, int pAmount)
    {
        ...
        pSource.sendSuccess(Component.a("commands.time.set", i), true);
        return i;
    }
}
