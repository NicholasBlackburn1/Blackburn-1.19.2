...
public class ForceLoadCommand
{
    ...
    {
        return Component.a("commands.forceload.toobig", p_137698_, p_137699_);
    });
    private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType((p_137691_, p_137692_) ->
    {
        return Component.a("commands.forceload.query.failure", p_137691_, p_137692_);
    });
    ...
    private static int queryForceLoad(CommandSourceStack p_137683_, ColumnPos p_137684_) throws CommandSyntaxException
    {
        ...
        if (flag)
        {
            p_137683_.sendSuccess(Component.a("commands.forceload.query.success", chunkpos, resourcekey.location()), false);
            return 1;
        }
        else
        {
    ...
    private static int listForceLoad(CommandSourceStack p_137681_)
    {
        ...
        if (i > 0)
        {
            ...
            if (i == 1)
            {
                p_137681_.sendSuccess(Component.a("commands.forceload.list.single", resourcekey.location(), s), false);
            }
            else
            {
                p_137681_.sendSuccess(Component.a("commands.forceload.list.multiple", i, resourcekey.location(), s), false);
            }
        }
        else
        {
            p_137681_.sendFailure(Component.a("commands.forceload.added.none", resourcekey.location()));
        }
    ...
    private static int removeAll(CommandSourceStack p_137696_)
    {
        ...
        p_137696_.sendSuccess(Component.a("commands.forceload.removed.all", resourcekey.location()), true);
        return 0;
    }
        ...
        if (i >= -30000000 && j >= -30000000 && k < 30000000 && l < 30000000)
        {
            ...
            else
            {
                ...
                else
                {
                    if (j2 == 1)
                    {
                        p_137686_.sendSuccess(Component.a("commands.forceload." + (p_137689_ ? "added" : "removed") + ".single", chunkpos, resourcekey.location()), true);
                    }
                    else
                    {
                        ChunkPos chunkpos1 = new ChunkPos(i1, j1);
                        ChunkPos chunkpos2 = new ChunkPos(k1, l1);
                        p_137686_.sendSuccess(Component.a("commands.forceload." + (p_137689_ ? "added" : "removed") + ".multiple", j2, resourcekey.location(), chunkpos1, chunkpos2), true);
                    }
