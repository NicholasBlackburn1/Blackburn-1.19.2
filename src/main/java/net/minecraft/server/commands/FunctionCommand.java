...
public class FunctionCommand
{
    ...
    private static int runFunction(CommandSourceStack pSource, Collection<CommandFunction> pFunctions)
    {
        ...
        {
            pSource.sendSuccess(Component.a("commands.function.success.single", i, pFunctions.iterator().next().getId()), true);
        }
        else
        {
            pSource.sendSuccess(Component.a("commands.function.success.multiple", i, pFunctions.size()), true);
        }
