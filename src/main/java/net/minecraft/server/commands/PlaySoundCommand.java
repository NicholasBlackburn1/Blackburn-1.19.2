        ...
        while (true)
        {
            ...
            while (true)
            {
                if (!iterator.hasNext())
                {
                    ...
                    if (pTargets.size() == 1)
                    {
                        pSource.sendSuccess(Component.a("commands.playsound.success.single", pSound, pTargets.iterator().next().getDisplayName()), true);
                    }
                    else
                    {
                        pSource.sendSuccess(Component.a("commands.playsound.success.multiple", pSound, pTargets.size()), true);
                    }
