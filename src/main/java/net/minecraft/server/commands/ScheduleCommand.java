...
public class ScheduleCommand
{
    ...
    {
        return Component.a("commands.schedule.cleared.failure", p_138437_);
    });
    ...
    private static int schedule(CommandSourceStack p_138429_, Pair<ResourceLocation, Either<CommandFunction, Collection<CommandFunction>>> p_138430_, int p_138431_, boolean p_138432_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            p_138430_.getSecond().ifLeft((p_138453_) ->
            {
                ...
                p_138429_.sendSuccess(Component.a("commands.schedule.created.function", resourcelocation, p_138431_, i), true);
            }).ifRight((p_214729_) ->
            {
                ...
                p_138429_.sendSuccess(Component.a("commands.schedule.created.tag", resourcelocation, p_138431_, i), true);
            });
    ...
    private static int remove(CommandSourceStack p_138434_, String p_138435_) throws CommandSyntaxException
    {
        ...
        {
            p_138434_.sendSuccess(Component.a("commands.schedule.cleared.success", i, p_138435_), true);
            return i;
        }
    }
}
