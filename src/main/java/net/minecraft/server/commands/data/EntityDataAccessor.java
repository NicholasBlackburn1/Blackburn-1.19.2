...
public class EntityDataAccessor implements DataAccessor
{
    ...
    {
        return Component.a("commands.data.entity.query", this.entity.getDisplayName(), NbtUtils.toPrettyComponent(pNbt));
    }

    public Component getPrintSuccess(NbtPathArgument.NbtPath pPath, double pScale, int p_139515_)
    {
        return Component.a("commands.data.entity.get", pPath, this.entity.getDisplayName(), String.format(Locale.ROOT, "%.2f", pScale), p_139515_);
    }
}
