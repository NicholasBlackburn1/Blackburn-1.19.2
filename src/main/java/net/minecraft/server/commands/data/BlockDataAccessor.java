...
public class BlockDataAccessor implements DataAccessor
{
    ...
    {
        return Component.a("commands.data.block.query", this.pos.getX(), this.pos.getY(), this.pos.getZ(), NbtUtils.toPrettyComponent(pNbt));
    }

    public Component getPrintSuccess(NbtPathArgument.NbtPath pPath, double pScale, int p_139303_)
    {
        return Component.a("commands.data.block.get", pPath, this.pos.getX(), this.pos.getY(), this.pos.getZ(), String.format(Locale.ROOT, "%.2f", pScale), p_139303_);
    }
}
