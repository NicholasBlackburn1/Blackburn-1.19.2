...
public class DifficultyCommand
{
    ...
    {
        return Component.a("commands.difficulty.failure", p_136948_);
    });
    ...
    public static void register(CommandDispatcher<CommandSourceStack> pDispatcher)
    {
        ...
        }).executes((p_136941_) ->
        {
            ...
            p_136941_.getSource().sendSuccess(Component.a("commands.difficulty.query", difficulty1.getDisplayName()), false);
    ...
    public static int setDifficulty(CommandSourceStack pSource, Difficulty pDifficulty) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(Component.a("commands.difficulty.success", pDifficulty.getDisplayName()), true);
            return 0;
        }
    }
}
