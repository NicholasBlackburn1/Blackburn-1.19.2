...
public class PlaceCommand
{
    ...
    {
        return Component.a("commands.place.template.invalid", p_214582_);
    });
    ...
    {
        p_214548_.register((LiteralArgumentBuilder<CommandSourceStack>) Commands.literal("place").requires((p_214560_) ->
        {
            return p_214560_.hasPermission(2);
        }).then(Commands.literal("feature").then(((RequiredArgumentBuilder)Commands.argument("feature", ResourceKeyArgument.key(Registry.CONFIGURED_FEATURE_REGISTRY)).executes((p_214610_) ->
        {
            return placeFeature((CommandSourceStack)p_214610_.getSource(), ResourceKeyArgument.getConfiguredFeature(p_214610_, "feature"), new BlockPos(((CommandSourceStack)p_214610_.getSource()).getPosition()));
    ...
    public static int placeFeature(CommandSourceStack p_214576_, Holder < ConfiguredFeature <? , ? >> p_214577_, BlockPos p_214578_) throws CommandSyntaxException
    {
        ...
        ConfiguredFeature <? , ? > configuredfeature = (ConfiguredFeature)p_214577_.value();
        ...
        else
        {
            ...
            p_214576_.sendSuccess(Component.a("commands.place.feature.success", s, p_214578_.getX(), p_214578_.getY(), p_214578_.getZ()), true);
            return 1;
        }
    }
    ...
    public static int placeJigsaw(CommandSourceStack p_214570_, Holder<StructureTemplatePool> p_214571_, ResourceLocation p_214572_, int p_214573_, BlockPos p_214574_) throws CommandSyntaxException
    {
        ...
        {
            p_214570_.sendSuccess(Component.a("commands.place.jigsaw.success", p_214574_.getX(), p_214574_.getY(), p_214574_.getZ()), true);
            return 1;
        }
    }
    ...
    public static int placeStructure(CommandSourceStack p_214588_, Holder<Structure> p_214589_, BlockPos p_214590_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            p_214588_.sendSuccess(Component.a("commands.place.structure.success", s, p_214590_.getX(), p_214590_.getY(), p_214590_.getZ()), true);
            return 1;
        }
    }
    ...
    public static int placeTemplate(CommandSourceStack p_214562_, ResourceLocation p_214563_, BlockPos p_214564_, Rotation p_214565_, Mirror p_214566_, float p_214567_, int p_214568_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            {
                p_214562_.sendSuccess(Component.a("commands.place.template.success", p_214563_, p_214564_.getX(), p_214564_.getY(), p_214564_.getZ()), true);
                return 1;
            }
        }
    }
