...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider
{
    ...
    public ChunkMap(ServerLevel p_214836_, LevelStorageSource.LevelStorageAccess p_214837_, DataFixer p_214838_, StructureTemplateManager p_214839_, Executor p_214840_, BlockableEventLoop<Runnable> p_214841_, LightChunkGetter p_214842_, ChunkGenerator p_214843_, ChunkProgressListener p_214844_, ChunkStatusUpdateListener p_214845_, Supplier<DimensionDataStorage> p_214846_, int p_214847_, boolean p_214848_)
    {
        ...
        {
            this.randomState = RandomState.create((NoiseGeneratorSettings)noisebasedchunkgenerator.generatorSettings().value(), p_214836_.registryAccess().registryOrThrow(Registry.NOISE_REGISTRY), p_214836_.getSeed());
        }
        else
        {
    ...
    ChunkHolder updateChunkScheduling(long pChunkPos, int p_140178_, @Nullable ChunkHolder pNewLevel, int pHolder)
    {
        ...
        else
        {
            ...
            {
                Reflector.ForgeEventFactory_fireChunkTicketLevelUpdated.call(this.level, pChunkPos, pHolder, p_140178_, pNewLevel);
            }
    ...
    public CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> schedule(ChunkHolder p_140293_, ChunkStatus p_140294_)
    {
        ...
        else
        {
            ...
            {
                CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture = p_140294_.load(this.level, this.structureTemplateManager, this.lightEngine, (p_203079_2_) ->
                {
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkLoad(ChunkPos pChunkPos)
    {
        ...
        }).<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>thenApplyAsync((p_214889_2_) ->
        {
            ...
            if (p_214889_2_.isPresent())
            {
                ChunkAccess chunkaccess = ChunkSerializer.read(this.level, this.poiManager, pChunkPos, p_214889_2_.get());
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkGeneration(ChunkHolder pChunkHolder, ChunkStatus pChunkStatus)
    {
        ...
        CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.getChunkRangeFuture(chunkpos, pChunkStatus.getRange(), (p_214933_2_) ->
        {
        ...
        {
            return p_214868_5_.map((p_241750_5_) -> {
                try {
                    CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture1 = pChunkStatus.generate(executor, this.level, this.generator, this.structureTemplateManager, this.lightEngine, (p_214917_2_) -> {
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> protoChunkToFullChunk(ChunkHolder p_140384_)
    {
        ...
        return completablefuture.thenApplyAsync((p_214851_2_) ->
        {
            ChunkStatus chunkstatus = ChunkHolder.getStatus(p_140384_.getTicketLevel());
            return !chunkstatus.isOrAfter(ChunkStatus.FULL) ? ChunkHolder.UNLOADED_CHUNK : p_214851_2_.mapLeft((p_214854_2_) -> {
        ...
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_214949_2_, p_140384_.getPos().toLong(), p_140384_::getTicketLevel));
        });
    }
    ...
    public CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> prepareTickingChunk(ChunkHolder p_143054_)
    {
        ...
        CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.getChunkRangeFuture(chunkpos, 1, (p_214915_0_) ->
        {
            return ChunkStatus.FULL;
        });
        CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> completablefuture1 = completablefuture.thenApplyAsync((p_212877_0_) ->
        {
        ...
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_143054_, p_214942_2_));
        ...
        {
            p_214880_2_.ifLeft((p_214883_2_) -> {
                this.tickingGenerated.getAndIncrement();
                MutableObject<ClientboundLevelChunkWithLightPacket> mutableobject = new MutableObject<>();
                this.getPlayers(chunkpos, false).forEach((p_214908_3_) -> {
                    this.playerLoadedChunk(p_214908_3_, mutableobject, p_214883_2_);
                });
            });
        }, (p_214920_2_) ->
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_143054_, p_214920_2_));
        });
        return completablefuture1;
    }
    ...
    {
        return this.getChunkRangeFuture(p_143110_.getPos(), 1, ChunkStatus::getStatusAroundFullChunk).thenApplyAsync((p_214892_0_) ->
        {
            return p_214892_0_.mapLeft((p_214904_0_) -> {
                return (LevelChunk)p_214904_0_.get(p_214904_0_.size() / 2);
            });
        }, (p_214857_2_) ->
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_143110_, p_214857_2_));
        });
    }
    ...
    protected void updateChunkTracking(ServerPlayer p_183755_, ChunkPos p_183756_, MutableObject<ClientboundLevelChunkWithLightPacket> p_183757_, boolean p_183758_, boolean p_183759_)
    {
        if (p_183755_.level == this.level)
        {
            ...
            if (!p_183759_ && p_183758_)
            {
                ...
                {
                    Reflector.ForgeEventFactory_fireChunkUnWatch.call(p_183755_, p_183756_, this.level);
                }
            }
        }
    }
    ...
    private void playerLoadedChunk(ServerPlayer p_183761_, MutableObject<ClientboundLevelChunkWithLightPacket> p_183762_, LevelChunk p_183763_)
    {
        ...
        {
            Reflector.ForgeEventFactory_fireChunkWatch.call(p_183761_, p_183763_, this.level);
        }
    }
