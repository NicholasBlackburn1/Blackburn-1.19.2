    ...
    public boolean award(Advancement pAdvancement, String pCriterionKey)
    {
        ...
        if (advancementprogress.grantProgress(pCriterionKey))
        {
            ...
            if (!flag1 && advancementprogress.isDone())
            {
                ...
                {
                    this.playerList.broadcastSystemMessage(Component.a("chat.type.advancement." + pAdvancement.getDisplay().getFrame().getName(), this.player.getDisplayName(), pAdvancement.getChatComponent()), false);
                }
            }
        }
