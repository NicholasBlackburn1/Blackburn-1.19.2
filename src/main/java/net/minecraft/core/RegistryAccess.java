...
default <E> Registry<E> registryOrThrow(ResourceKey<? extends Registry<? extends E>> pRegistryKey)
    ...
    {
        pBuilder.put(pRegistryKey, new RegistryAccess.RegistryData<E>(pRegistryKey, pElementCodec, (Codec<E>)null));
    }
    ...
    {
        pBuilder.put(pRegistryKey, new RegistryAccess.RegistryData<E>(pRegistryKey, pElementCodec, pNetworkCodec));
    }
...
default Stream<RegistryAccess.RegistryEntry<?>> networkSafeRegistries()
    ...
    private Stream < RegistryAccess.RegistryEntry<? >> ownedNetworkableRegistries()
    {
        ...
        {
            return ((RegistryAccess.RegistryData)REGISTRIES.get(p_206170_.key)).sendToClient();
        });
    }
    ...
    static RegistryAccess.Writable builtinCopy()
    {
        ...
        {
            addBuiltinElements(registryresourceaccess$inmemorystorage, (RegistryAccess.RegistryData)entry.getValue());
        }
