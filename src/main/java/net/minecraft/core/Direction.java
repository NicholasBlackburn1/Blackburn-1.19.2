...
public enum Direction implements StringRepresentable
{
    ...
    private static final Long2ObjectMap<Direction> BY_NORMAL = Arrays.stream(VALUES).collect(Collectors.toMap((p_235678_0_) -> {
        return (new BlockPos(p_235678_0_.getNormal())).asLong();
    }, (p_235674_0_) -> {
        return p_235674_0_;
    }, (p_235669_0_, p_235669_1_) -> {
    ...
    {
        return Util.b(values(), p_235668_);
    }
    ...
    public static enum Plane implements Iterable<Direction>, Predicate<Direction> {
        ...
        {
            return Util.b(this.faces, p_235695_);
        }
    }
}
