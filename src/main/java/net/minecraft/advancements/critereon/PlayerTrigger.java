...
public class PlayerTrigger extends SimpleCriterionTrigger<PlayerTrigger.TriggerInstance>
{
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        ...
        {
            return located(EntityPredicate.Builder.entity().equipment(EntityEquipmentPredicate.Builder.equipment().feet(ItemPredicate.Builder.item().a(p_222639_).build()).build()).steppingOn(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().a(p_222638_).build()).build()).build());
        }
    }
}
