...
public class KeyboardHandler
{
    ...
    {
        this.minecraft.gui.getChat().addMessage(Component.empty().append(Component.translatable("debug.prefix").a(p_167825_, ChatFormatting.BOLD)).append(" ").append(p_167826_));
    }
    ...
    {
        this.debugFeedbackComponent(Component.a(p_90914_, p_90915_));
    }

    private void b(String p_90949_, Object... p_90950_)
    {
        this.debugComponent(ChatFormatting.RED, Component.a(p_90949_, p_90950_));
    }
        ...
        else
        {
            switch (pKey)
            {
                ...
                case 86:
                    ...
                    Component component = Component.literal(I18n.a("of.message.loadingVisibleChunks"));
                    LevelRenderer.loadVisibleChunksMessageId = new MessageSignature(RandomUtils.getRandomBytes(16));
                    minecraft.gui.getChat().addMessage(component, LevelRenderer.loadVisibleChunksMessageId, GuiMessageTag.system());
                    return true;
    ...
    public void keyPress(long pWindowPointer, int p_90895_, int pKey, int pScanCode, int pAction)
    {
        if (pWindowPointer == this.minecraft.getWindow().getWindow())
        {
            ...
            Reflector.ForgeHooksClient_onKeyInput.call(p_90895_, pKey, pScanCode, pAction);
        }
    }
