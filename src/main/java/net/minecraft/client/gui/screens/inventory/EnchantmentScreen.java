    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick)
    {
        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            if (this.isHovering(60, 14 + 19 * j, 108, 17, (double)pMouseX, (double)pMouseY) && k > 0 && l >= 0 && enchantment != null)
            {
                ...
                list.add(Component.a("container.enchant.clue", enchantment.getFullname(l)).withStyle(ChatFormatting.WHITE));
                ...
                if (!flag)
                {
                    ...
                    {
                        list.add(Component.a("container.enchant.level.requirement", (this.menu).costs[j]).withStyle(ChatFormatting.RED));
                    }
                    else
                    {
                        ...
                        {
                            mutablecomponent = Component.a("container.enchant.lapis.many", i1);
                        }
                        ...
                        {
                            mutablecomponent1 = Component.a("container.enchant.level.many", i1);
                        }
