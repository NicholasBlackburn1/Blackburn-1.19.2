    ...
    public class KeyEntry extends KeyBindsList.Entry
    {
        ...
        KeyEntry(final KeyMapping p_193916_, final Component p_193917_)
        {
            ...
            })
            {
                ...
                {
                    return p_193916_.isUnbound() ? Component.a("narrator.controls.unbound", p_193917_) : Component.a("narrator.controls.bound", p_193917_, super.createNarrationMessage());
                }
            };
            ...
            })
            {
                protected MutableComponent createNarrationMessage()
                {
                    return Component.a("narrator.controls.reset", p_193917_);
                }
            };
        }
