...
public class OptimizeWorldScreen extends Screen
{
    ...
    {
        super(Component.a("optimizeWorld.title", p_194067_.levelName()));
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick)
    {
        ...
        if (this.upgrader.getTotalChunks() > 0)
        {
            ...
            drawString(pPoseStack, this.font, Component.a("optimizeWorld.info.converted", this.upgrader.getConverted()), i, 40, 10526880);
            drawString(pPoseStack, this.font, Component.a("optimizeWorld.info.skipped", this.upgrader.getSkipped()), i, 40 + 9 + 3, 10526880);
            drawString(pPoseStack, this.font, Component.a("optimizeWorld.info.total", this.upgrader.getTotalChunks()), i, 40 + (9 + 3) * 2, 10526880);
            int i1 = 0;
