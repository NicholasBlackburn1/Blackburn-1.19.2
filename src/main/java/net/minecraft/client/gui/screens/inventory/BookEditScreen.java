...
public class BookEditScreen extends Screen
{
    ...
    public BookEditScreen(Player pOwner, ItemStack pBook, InteractionHand pHand)
    {
        ...
        this.ownerText = Component.a("book.byAuthor", pOwner.getName()).withStyle(ChatFormatting.DARK_GRAY);
    }
    ...
    private BookEditScreen.DisplayCache getDisplayCache()
    {
        if (this.displayCache == null)
        {
            ...
            this.pageMsg = Component.a("book.pageIndicator", this.currentPage + 1, this.getNumPages());
        }
