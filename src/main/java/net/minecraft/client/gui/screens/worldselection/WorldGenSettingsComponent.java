...
public class WorldGenSettingsComponent implements Widget
{
    ...
    void updateSettings(WorldCreationContext.SimpleUpdater pSettings)
    {
        this.settings = this.settings.withSettings(pSettings);
    }

    void updateSettings(WorldCreationContext.Updater pSettings)
    {
        this.settings = this.settings.withSettings(pSettings);
    }
