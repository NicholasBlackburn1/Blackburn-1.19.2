...
public class SocialInteractionsScreen extends Screen
{
    ...
    private void updateServerLabel(Minecraft pMinecraft)
    {
        ...
        if (this.playerCount != i)
        {
            ...
            if (i > 1)
            {
                this.serverLabel = Component.a("gui.socialInteractions.server_label.multiple", s, i);
            }
            else
            {
                this.serverLabel = Component.a("gui.socialInteractions.server_label.single", s, i);
            }
