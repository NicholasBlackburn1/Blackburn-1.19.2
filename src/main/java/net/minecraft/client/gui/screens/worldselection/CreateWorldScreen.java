...
public class CreateWorldScreen extends Screen
{
    ...
    public static void openFresh(Minecraft p_232897_, @Nullable Screen p_232898_)
    {
        ...
        p_232897_.setScreen(new CreateWorldScreen(p_232898_, DataPackConfig.DEFAULT, new WorldGenSettingsComponent((WorldCreationContext)completablefuture.join(), Optional.of(WorldPresets.NORMAL), OptionalLong.empty())));
    }
    ...
    protected void init()
    {
        ...
        this.modeButton = this.addRenderableWidget(CycleButton.builder(CreateWorldScreen.SelectedGameMode::getDisplayName).a(CreateWorldScreen.SelectedGameMode.SURVIVAL, CreateWorldScreen.SelectedGameMode.HARDCORE, CreateWorldScreen.SelectedGameMode.CREATIVE).withInitialValue(this.gameMode).withCustomNarration((p_232940_) ->
        {
        ...
        this.difficultyButton = this.addRenderableWidget(CycleButton.builder(Difficulty::getDisplayName).a(Difficulty.values()).withInitialValue(this.getEffectiveDifficulty()).create(j, 100, 150, 20, Component.translatable("options.difficulty"), (p_232907_, p_232908_) ->
        {
