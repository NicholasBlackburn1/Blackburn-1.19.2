...
public class LoadingOverlay extends Overlay
{
    ...
    static Consts starblazer = new Consts();
    ...
    static class LogoTexture extends SimpleTexture
    {
        ...
        {
            return resourceManager.getResource(LoadingOverlay.MOJANG_STUDIOS_LOGO_LOCATION).isPresent() ? resourceManager.getResource(LoadingOverlay.MOJANG_STUDIOS_LOGO_LOCATION).get().open() : vanillapack.getResource(PackType.CLIENT_RESOURCES, LoadingOverlay.MOJANG_STUDIOS_LOGO_LOCATION);
        }
    }
}
