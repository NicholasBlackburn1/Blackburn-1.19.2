        ...
        public RuleList(final GameRules p_101203_)
        {
            ...
            GameRules.visitGameRuleTypes(new GameRules.GameRuleTypeVisitor()
            {
                ...
                private <T extends GameRules.Value<T>> void addEntry(GameRules.Key<T> p_101225_, EditGameRulesScreen.EntryFactory<T> p_101226_)
                {
                    ...
                    Component component2 = Component.a("editGamerule.default", Component.literal(s)).withStyle(ChatFormatting.GRAY);
            ...
            {
                this.addEntry(EditGameRulesScreen.this.new CategoryRuleEntry(Component.translatable(p_101210_.getKey().getDescriptionId()).a(ChatFormatting.BOLD, ChatFormatting.YELLOW)));
