...
public class CycleButton<T> extends AbstractButton implements TooltipAccessor, IOptionControl
{
    ...
    public void updateNarration(NarrationElementOutput pNarrationElementOutput)
    {
        ...
        if (this.active)
        {
            ...
            if (this.isFocused())
            {
                pNarrationElementOutput.add(NarratedElementType.USAGE, Component.a("narration.cycle_button.usage.focused", component));
            }
            else
            {
                pNarrationElementOutput.add(NarratedElementType.USAGE, Component.a("narration.cycle_button.usage.hovered", component));
            }
        }
    }
    ...
    public static class Builder<T>
    {
        ...
        private final Function<T, Component> valueStringifier;
        private OptionInstance.TooltipSupplier<T> tooltipSupplier = (p_168963_0_) ->
        {
