...
public class EditBox extends AbstractWidget implements Widget, GuiEventListener
{
    ...
    protected MutableComponent createNarrationMessage()
    {
        ...
        return Component.a("gui.narrate.editBox", component, this.value);
    }
    ...
    {
        pNarrationElementOutput.add(NarratedElementType.TITLE, Component.a("narration.edit_box", this.getValue()));
    }
}
