...
public class MultiLineEditBox extends AbstractScrollWidget
{
    ...
    {
        p_240122_.add(NarratedElementType.TITLE, Component.a("narration.edit_box", this.getValue()));
    }
    ...
    protected void renderDecorations(PoseStack p_239517_)
    {
        ...
        if (this.textField.hasCharacterLimit())
        {
            ...
            Component component = Component.a("gui.multiLineEditBox.character_limit", this.textField.value().length(), i);
