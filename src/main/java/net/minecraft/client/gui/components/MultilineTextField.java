...
public class MultilineTextField
{
    ...
    public int getLineAtCursor()
    {
        ...
        {
            MultilineTextField.StringView multilinetextfield$stringview = (MultilineTextField.StringView)this.displayLines.get(i);
    ...
    {
        return (MultilineTextField.StringView)this.displayLines.get(Mth.clamp(p_239145_, 0, this.displayLines.size() - 1));
    }
    ...
    public void seekCursorToPoint(double p_239579_, double p_239580_)
    {
        ...
        MultilineTextField.StringView multilinetextfield$stringview = (MultilineTextField.StringView)this.displayLines.get(Mth.clamp(j, 0, this.displayLines.size() - 1));
    ...
    private MultilineTextField.StringView getCursorLineView(int p_239855_)
    {
        ...
        {
            return (MultilineTextField.StringView)this.displayLines.get(Mth.clamp(i + p_239855_, 0, this.displayLines.size() - 1));
        }
    }
