            ...
            for (PeriodicNotificationManager.Notification periodicnotificationmanager$notification : this.notifications)
            {
                if (i >= periodicnotificationmanager$notification.delay)
                {
                    ...
                    if (k != l)
                    {
                        ...
                        {
                            SystemToast.add(Minecraft.getInstance().getToasts(), SystemToast.SystemToastIds.PERIODIC_NOTIFICATION, Component.a(periodicnotificationmanager$notification.title, k), Component.a(periodicnotificationmanager$notification.message, k));
                        });
                        return;
                    }
                }
