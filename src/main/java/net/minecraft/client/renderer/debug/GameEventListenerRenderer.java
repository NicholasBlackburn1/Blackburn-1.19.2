...
public class GameEventListenerRenderer implements DebugRenderer.SimpleDebugRenderer
{
    ...
    public void render(PoseStack pPoseStack, MultiBufferSource pBufferSource, double pCamX, double p_173849_, double pCamY)
    {
        ...
        {
            Vec3 vec3 = new Vec3(pCamX, 0.0D, pCamY);
            ...
            for (GameEventListenerRenderer.TrackedListener gameeventlistenerrenderer$trackedlistener : this.trackedListeners)
            {
                gameeventlistenerrenderer$trackedlistener.getPosition(level).ifPresent((p_234531_) ->
                {
                    ...
                    LevelRenderer.renderVoxelShape(pPoseStack, vertexconsumer, Shapes.create(new AABB(d7, d8, d9, d10, d11, d12)), -pCamX, -p_173849_, -pCamY, vector3f.x(), vector3f.y(), vector3f.z(), 0.35F);
                });
            }
            ...
            for (GameEventListenerRenderer.TrackedListener gameeventlistenerrenderer$trackedlistener1 : this.trackedListeners)
            {
                ...
                {
                    Vector3f vector3f = new Vector3f(1.0F, 1.0F, 0.0F);
                    LevelRenderer.addChainedFilledBoxVertices(bufferbuilder, p_234523_.x() - 0.25D - pCamX, p_234523_.y() - p_173849_, p_234523_.z() - 0.25D - pCamY, p_234523_.x() + 0.25D - pCamX, p_234523_.y() - p_173849_ + 1.0D, p_234523_.z() + 0.25D - pCamY, vector3f.x(), vector3f.y(), vector3f.z(), 0.35F);
                });
            }
