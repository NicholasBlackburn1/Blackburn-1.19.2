...
public class EntityRenderers
{
    ...
    public static Map < EntityType, EntityRenderer> createEntityRenderers(EntityRendererProvider.Context p_174050_)
    {
        ...
        {
            try {
                builder.put(p_234599_2_, p_234599_3_.create(p_174050_));
            }
            catch (Exception exception)
            {
                throw new IllegalArgumentException("Failed to create model for " + Registry.ENTITY_TYPE.getKey(p_234599_2_), exception);
            }
        });
    ...
    public static Map < String, EntityRenderer> createPlayerRenderers(EntityRendererProvider.Context p_174052_)
    {
        ...
        {
            try {
                builder.put(p_234604_2_, p_234604_3_.create(p_174052_));
            }
            catch (Exception exception)
            {
                throw new IllegalArgumentException("Failed to create player model for " + p_234604_2_, exception);
            }
        });
        return builder.build();
    }
