...
public class ModelBlockRenderer
{
    ...
    public void tesselateBlock(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, RandomSource pRandom, long pSeed, int p_234389_)
    {
        this.tesselateBlock(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, p_234389_, ModelData.EMPTY, (RenderType)null);
    }
    ...
    {
        boolean flag = Minecraft.useAmbientOcclusion() && ReflectorForge.getLightEmission(stateIn, worldIn, posIn) == 0 && modelIn.useAmbientOcclusion(stateIn, renderType);
    ...
    public void tesselateWithAO(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, RandomSource pRandom, long pSeed, int p_234400_)
    {
        this.renderModelSmooth(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, p_234400_, ModelData.EMPTY, (RenderType)null);
    }
    ...
    public void tesselateWithoutAO(BlockAndTintGetter pLevel, BakedModel pModel, BlockState pState, BlockPos pPos, PoseStack pPoseStack, VertexConsumer pConsumer, boolean pCheckSides, RandomSource pRandom, long pSeed, int p_234411_)
    {
        this.renderModelFlat(pLevel, pModel, pState, pPos, pPoseStack, pConsumer, pCheckSides, pRandom, pSeed, p_234411_, ModelData.EMPTY, (RenderType)null);
    }
