...
public class ChatListener
{
            ...
            this.handleMessage(new ChatListener.Message()
            {
                ...
                public boolean accept()
                {
                    if (this.removed)
                    {
                        ...
                        ChatListener.this.b(p_241568_.signedHeader(), p_241568_.headerSignature(), abyte);
                        return false;
                    }
                    else
                    {
    ...
    public void a(SignedMessageHeader p_241319_, MessageSignature p_241390_, byte[] p_241463_)
    {
        this.handleMessage(() ->
        {
            return this.b(p_241319_, p_241390_, p_241463_);
        });
    }
    ...
    boolean b(SignedMessageHeader p_241363_, MessageSignature p_241535_, byte[] p_241500_)
    {
        PlayerInfo playerinfo = this.resolveSenderPlayer(p_241363_.sender());

        if (playerinfo != null)
        {
            SignedMessageValidator.State signedmessagevalidator$state = playerinfo.getMessageValidator().a(p_241363_, p_241535_, p_241500_);
        ...
        this.c(p_241363_, p_241535_, p_241500_);
        return false;
    }
    ...
    private void c(SignedMessageHeader p_241328_, MessageSignature p_241317_, byte[] p_241565_)
    {
        ChatLog chatlog = this.minecraft.getReportingContext().chatLog();
        chatlog.push(LoggedChatMessageLink.a(p_241328_, p_241317_, p_241565_));
    }
