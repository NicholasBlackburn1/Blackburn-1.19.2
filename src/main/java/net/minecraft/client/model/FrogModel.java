...
public class FrogModel<T extends Frog> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_233362_.getChilds("root");
        this.body = this.root.getChilds("body");
        this.head = this.body.getChilds("head");
        this.eyes = this.head.getChilds("eyes");
        this.tongue = this.body.getChilds("tongue");
        this.leftArm = this.body.getChilds("left_arm");
        this.rightArm = this.body.getChilds("right_arm");
        this.leftLeg = this.root.getChilds("left_leg");
        this.rightLeg = this.root.getChilds("right_leg");
        this.croakingBody = this.body.getChilds("croaking_body");
    }
