...
public class BoatModel extends ListModel<Boat>
{
    ...
    {
        this.leftPaddle = p_233345_.getChilds("left_paddle");
        this.rightPaddle = p_233345_.getChilds("right_paddle");
        this.waterPatch = p_233345_.getChilds("water_patch");
        ImmutableList.Builder<ModelPart> builder = new ImmutableList.Builder<>();
        builder.add(p_233345_.getChilds("bottom"), p_233345_.getChilds("back"), p_233345_.getChilds("front"), p_233345_.getChilds("right"), p_233345_.getChilds("left"), this.leftPaddle, this.rightPaddle);

        if (p_233346_)
        {
            builder.add(p_233345_.getChilds("chest_bottom"));
            builder.add(p_233345_.getChilds("chest_lid"));
            builder.add(p_233345_.getChilds("chest_lock"));
        }
