...
public class WardenModel<T extends Warden> extends HierarchicalModel<T>
{
    ...
    public WardenModel(ModelPart p_233512_)
    {
        ...
        this.root = p_233512_;
        this.bone = p_233512_.getChilds("bone");
        this.body = this.bone.getChilds("body");
        this.head = this.body.getChilds("head");
        this.rightLeg = this.bone.getChilds("right_leg");
        this.leftLeg = this.bone.getChilds("left_leg");
        this.rightArm = this.body.getChilds("right_arm");
        this.leftArm = this.body.getChilds("left_arm");
        this.rightTendril = this.head.getChilds("right_tendril");
        this.leftTendril = this.head.getChilds("left_tendril");
        this.rightRibcage = this.body.getChilds("right_ribcage");
        this.leftRibcage = this.body.getChilds("left_ribcage");
