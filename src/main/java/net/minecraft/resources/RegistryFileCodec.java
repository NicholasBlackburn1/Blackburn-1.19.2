        ...
        if (pOps instanceof RegistryOps<?> registryops)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        return ((RegistryLoader.Bound)optional1.get()).overrideElementFromResources(this.registryKey, this.elementCodec, resourcekey, registryops.getAsJson()).map((p_206706_) ->
                        {
