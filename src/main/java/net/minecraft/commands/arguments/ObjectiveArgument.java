...
public class ObjectiveArgument implements ArgumentType<String>
{
    ...
    private static final DynamicCommandExceptionType ERROR_OBJECTIVE_NOT_FOUND = new DynamicCommandExceptionType((p_101970_0_) ->
    {
        return Component.a("arguments.objective.notFound", p_101970_0_);
    });
    private static final DynamicCommandExceptionType ERROR_OBJECTIVE_READ_ONLY = new DynamicCommandExceptionType((p_101968_0_) ->
    {
        return Component.a("arguments.objective.readonly", p_101968_0_);
    });
