...
public record ArgumentSignatures(List<ArgumentSignatures.Entry> entries)
{
    ...
    public static ArgumentSignatures signCommand(PreviewableCommand<?> p_242877_, ArgumentSignatures.Signer p_242891_)
    {
        ...
        {
            MessageSignature messagesignature = p_242891_.sign((String)p_242081_.getFirst(), (String)p_242081_.getSecond());
            return new ArgumentSignatures.Entry((String)p_242081_.getFirst(), messagesignature);
        }).toList();
