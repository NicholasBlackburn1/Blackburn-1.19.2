        ...
        (new Thread("Realms-connect-task")
        {
            public void run()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    DisconnectedRealmsScreen disconnectedrealmsscreen = new DisconnectedRealmsScreen(RealmsConnect.this.onlineScreen, CommonComponents.CONNECT_FAILED, Component.a("disconnect.genericReason", s2));
                    minecraft.execute(() ->
                    {
