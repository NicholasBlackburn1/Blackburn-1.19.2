...
public class TreePlacements
{
    ...
    public static final Holder<PlacedFeature> MANGROVE_CHECKED = PlacementUtils.a("mangrove_checked", TreeFeatures.MANGROVE, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
    public static final BlockPredicate SNOW_TREE_PREDICATE = BlockPredicate.a(Direction.DOWN.getNormal(), Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW);
    public static final List<PlacementModifier> SNOW_TREE_FILTER_DECORATOR = List.of(EnvironmentScanPlacement.scanningFor(Direction.UP, BlockPredicate.not(BlockPredicate.a(Blocks.POWDER_SNOW)), 8), BlockPredicateFilter.forPredicate(SNOW_TREE_PREDICATE));
    ...
    public static final Holder<PlacedFeature> TALL_MANGROVE_CHECKED = PlacementUtils.a("tall_mangrove_checked", TreeFeatures.TALL_MANGROVE, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
