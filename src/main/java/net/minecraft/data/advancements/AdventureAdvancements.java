...
public class AdventureAdvancements implements Consumer<Consumer<Advancement>>
{
    ...
    {
        return LightningStrikeTrigger.TriggerInstance.lighthingStrike(EntityPredicate.Builder.entity().distance(DistancePredicate.absolute(MinMaxBounds.Doubles.atMost(30.0D))).subPredicate(LighthingBoltPredicate.blockSetOnFire(pBlocksSetOnFire)).build(), pBystander);
    }

    private static UsingItemTrigger.TriggerInstance lookAtThroughItem(EntityType<?> pLookedAtEntityType, Item pLookedThroughItem)
    {
        return UsingItemTrigger.TriggerInstance.lookingAt(EntityPredicate.Builder.entity().subPredicate(PlayerPredicate.Builder.player().setLookingAt(EntityPredicate.Builder.entity().of(pLookedAtEntityType).build()).build()), ItemPredicate.Builder.item().a(pLookedThroughItem));
    }
    ...
    public void accept(Consumer<Advancement> p_123983_)
    {
        ...
        Advancement.Builder.advancement().parent(advancement6).display(Items.CROSSBOW, Component.translatable("advancements.adventure.whos_the_pillager_now.title"), Component.translatable("advancements.adventure.whos_the_pillager_now.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("kill_pillager", KilledByCrossbowTrigger.TriggerInstance.a(EntityPredicate.Builder.entity().of(EntityType.PILLAGER))).save(p_123983_, "adventure/whos_the_pillager_now");
