...
public class ItemTagsProvider extends TagsProvider<Item>
{
    ...
    protected void addTags()
    {
        ...
        this.tag(ItemTags.BOATS).a(Items.OAK_BOAT, Items.SPRUCE_BOAT, Items.BIRCH_BOAT, Items.JUNGLE_BOAT, Items.ACACIA_BOAT, Items.DARK_OAK_BOAT, Items.MANGROVE_BOAT).addTag(ItemTags.CHEST_BOATS);
        this.tag(ItemTags.CHEST_BOATS).a(Items.OAK_CHEST_BOAT, Items.SPRUCE_CHEST_BOAT, Items.BIRCH_CHEST_BOAT, Items.JUNGLE_CHEST_BOAT, Items.ACACIA_CHEST_BOAT, Items.DARK_OAK_CHEST_BOAT, Items.MANGROVE_CHEST_BOAT);
