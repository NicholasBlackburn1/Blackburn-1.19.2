...
public class BuiltinRegistries
{
    ...
    private static <T> Registry<T> registerSimple(ResourceKey <? extends Registry<T >> pRegistryKey, BuiltinRegistries.RegistryBootstrap<T> pDefaultSupplier)
    {
        return registerSimple(pRegistryKey, Lifecycle.stable(), pDefaultSupplier);
    }

    private static <T> Registry<T> registerSimple(ResourceKey <? extends Registry<T >> pRegistryKey, Lifecycle pLifecycle, BuiltinRegistries.RegistryBootstrap<T> pDefaultSupplier)
    {
    ...
    private static <T, R extends WritableRegistry<T>> R internalRegister(ResourceKey <? extends Registry<T >> pRegistryKey, R pRegistry, BuiltinRegistries.RegistryBootstrap<T> pDefaultSupplier, Lifecycle pLifecycle)
    {
        ResourceLocation resourcelocation = pRegistryKey.location();
        LOADERS.put(resourcelocation, () ->
        {
            return pDefaultSupplier.run(pRegistry);
        });
