...
public class LastSeenMessagesValidator
{
    ...
    private int a(List<LastSeenMessages.Entry> p_242209_, int[] p_242285_, @Nullable LastSeenMessages.Entry p_242264_)
    {
        ...
        for (int l = 0; l < k1; ++l)
        {
            LastSeenMessages.Entry lastseenmessages$entry = (LastSeenMessages.Entry)this.pendingEntries.get(l);
    ...
    public Set<LastSeenMessagesValidator.ErrorCondition> validateAndUpdate(LastSeenMessages.Update p_242403_)
    {
        ...
        LastSeenMessages.Entry lastseenmessages$entry = (LastSeenMessages.Entry)p_242403_.lastReceived().orElse(null);
        ...
        int[] aint = new int[k];
        int l = this.a(list, aint, lastseenmessages$entry);
