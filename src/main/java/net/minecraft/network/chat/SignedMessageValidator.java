...
public interface SignedMessageValidator
{
    ...
    SignedMessageValidator.State a(SignedMessageHeader p_241472_, MessageSignature p_241508_, byte[] p_241320_);
    ...
    public static class KeyBased implements SignedMessageValidator
    {
        ...
        private boolean a(SignedMessageHeader p_243269_, MessageSignature p_243259_, byte[] p_243265_, boolean p_243221_)
        {
            return this.validateChain(p_243269_, p_243259_, p_243221_) && p_243259_.a(this.validator, p_243269_, p_243265_);
        }

        private SignedMessageValidator.State b(SignedMessageHeader p_243211_, MessageSignature p_243274_, byte[] p_243209_, boolean p_243324_)
        {
            this.isChainConsistent = this.isChainConsistent && this.a(p_243211_, p_243274_, p_243209_, p_243324_);
        ...
        public SignedMessageValidator.State a(SignedMessageHeader p_242886_, MessageSignature p_242853_, byte[] p_242869_)
        {
            return this.b(p_242886_, p_242853_, p_242869_, false);
        }
        ...
        public SignedMessageValidator.State validateMessage(PlayerChatMessage p_242943_)
        {
            ...
            return this.b(p_242943_.signedHeader(), p_242943_.headerSignature(), abyte, true);
        }
    }
    ...
    public static class Unsigned implements SignedMessageValidator
    {
        ...
        public SignedMessageValidator.State a(SignedMessageHeader p_243299_, MessageSignature p_243315_, byte[] p_243252_)
        {
