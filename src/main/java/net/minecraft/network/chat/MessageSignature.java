...
public record MessageSignature(byte[] bytes)
{
    ...
    public boolean a(SignatureValidator p_241537_, SignedMessageHeader p_241482_, byte[] p_241502_)
    {
        return !this.isEmpty() ? p_241537_.validate((p_241245_) ->
        {
            p_241482_.a(p_241245_, p_241502_);
        }, this.bytes) : false;
    }
