...
public class DebugEntityNameGenerator
{
    ...
    public static String getEntityName(UUID pUuid)
    {
        ...
        return a(randomsource, NAMES_FIRST_PART) + a(randomsource, NAMES_SECOND_PART);
    }

    private static String a(RandomSource p_237881_, String[] p_237882_)
    {
        return Util.a(p_237882_, p_237881_);
    }
