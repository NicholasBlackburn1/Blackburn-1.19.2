...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener>
{
    ...
    {
        this.entries = pRoot.readList(ClientboundCommandsPacket::readNode);
        this.rootIndex = pRoot.readVarInt();
    ...
    static class Entry
    {
        ...
        Entry(@Nullable ClientboundCommandsPacket.NodeStub pBuilder, int pFlags, int pRedirect, int[] pChildren)
        {
            this.stub = pBuilder;
            this.flags = pFlags;
